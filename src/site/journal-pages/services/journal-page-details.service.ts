...
export function getPortalJournalPageDetails(id: string): Promise<any> {
  return axios.get(
    `${process.env.REACT_APP_BASE_URL}/boom/services/rest/pagemanagement/v1/${id}`
  );
}

export function updatePortalJournalPageLayout(
  layout: any,
...
export function publishPortalJournalPage(pageId: string): Promise<any> {
  return axios.post(
    `${process.env.REACT_APP_BASE_URL}/boom/services/rest/pagemanagement/v1/publish/${pageId}`
  );
}

export function revertPortalJournalPage(pageId: string): Promise<any> {
  return axios.post(
    `${process.env.REACT_APP_BASE_URL}/boom/services/rest/pagemanagement/v1/revert/${pageId}`
  );
}

export function deletePortalJournalPage(pageId: string): Promise<any> {
  return axios.delete(
    `${process.env.REACT_APP_BASE_URL}/boom/services/rest/pagemanagement/v1/${pageId}`
  );
}
export function addPortalJournalPageWidget(form: any, pageId: string): Promise<any> {
  return axios.post(
...
export function updatePortalJournalPageWidget(
  form: any,
  pageId: string
): Promise<any> {
  return axios.post(
...
export function deleteJournalPageWidget(
  widgetId: string,
  pageId: string
): Promise<any> {
  return axios.delete(
