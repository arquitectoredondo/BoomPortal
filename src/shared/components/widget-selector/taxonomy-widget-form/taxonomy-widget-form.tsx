...
import "./taxonomy-widget-form.scss";
import {
  Box,
  Button,
  makeStyles,
...
interface TaxonomyWidgetFormProps {
  id?: string;
  onSave: (form: any) => void;
  onCancel: () => void;
  taxonomyWidgetData?: PageWidget;
}

export default function TaxonomyWidgetForm(
  props: TaxonomyWidgetFormProps
): JSX.Element {
  ...
  React.useEffect(() => {
    if (props.taxonomyWidgetData) {
      setTitle(props.taxonomyWidgetData.title);
      setBackgroundColor(props.taxonomyWidgetData.backgroundColor);
      setSampleBackgroundColor(
        props.taxonomyWidgetData.backgroundColor || "transparent"
      );
      setBorderBottom(props.taxonomyWidgetData.borderBottom);
      setBorderLeft(props.taxonomyWidgetData.borderLeft);
      setBorderRight(props.taxonomyWidgetData.borderRight);
      setBorderTop(props.taxonomyWidgetData.borderTop);
    }
  ...
  const handleSaveButton = () => {
    ...
    if (props.taxonomyWidgetData) {
      saveTaxonomyWidget = {
        ...saveTaxonomyWidget,
        uuid: props.taxonomyWidgetData.uuid,
        x: props.taxonomyWidgetData.x,
        y: props.taxonomyWidgetData.y,
        h: props.taxonomyWidgetData.h,
        w: props.taxonomyWidgetData.w,
        minH: props.taxonomyWidgetData.minH,
        minW: props.taxonomyWidgetData.minW,
      };
    }
  ...
  return (
    <Box
      id={props.id}
      className="taxonomy-widget-body"
      component="form"
      style={{
        display: "flex",
