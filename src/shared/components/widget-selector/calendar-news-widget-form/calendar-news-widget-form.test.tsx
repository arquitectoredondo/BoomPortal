...
import CalendarNewsWidgetForm from './calendar-news-widget-form';
...
const initProps: any = {
  ...
  onSave: jest.fn(),
  onCancel: jest.fn(),
  calendarNewsWidgetData: mockBanner,
};

function setup(props: any): any {
  const enzymeWrapper: ShallowWrapper = shallow(
    <CalendarNewsWidgetForm {...props} />
  );
...
describe('CalendarNewsWidgetForm', () => {
